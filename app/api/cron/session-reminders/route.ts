        ...
        await db.notification.createMany({
          data: [
            // Student notification (using student's timezone)
            {
              ...
              message: `Your session with ${booking.mentor.name} starts in 1 hour at ${studentSessionTimeStr}`,
            ...
            // Mentor notification (using mentor's timezone)
            {
              ...
              type: "SESSION_REMINDER_1H",
              title: "Session in 1 hour!",
              message: `Your session with ${booking.user.name || "a student"} starts in 1 hour at ${mentorSessionTimeStr}`,
