        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8 shadow-xl backdrop-blur">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-white/60">
              Get started with BeMyMentor. Already have an account?{" "}
              <Link href="/signin" className="text-purple-400 underline underline-offset-4 hover:text-purple-300">
                Sign in
              </Link>
            </p>
          </div>
