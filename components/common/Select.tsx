...
export default function Select({
  ...
  return (
    <select
      className={cn(
        "h-12 w-full rounded-lg border-2 border-white/20 bg-neutral-900 px-4 text-base text-white outline-none",
        "transition-all duration-200",
        "hover:border-white/30 hover:bg-neutral-800",
        "focus:border-primary-500 focus:bg-neutral-800 focus:ring-2 focus:ring-primary-500/20",
        ...
        // Fix option styling for all browsers - dark background with white text
        "[&>option]:text-white [&>option]:bg-neutral-900",
        className
      )}
      {...props}
    >
